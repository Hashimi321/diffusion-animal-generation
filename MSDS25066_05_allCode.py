...
# ==============================================================================
# MSDS25066_05_allCode.py
# Name: Saad Ali | Roll No: MSDS25066
# Assignment 5 (Bonus) - Image Generation Using Diffusion Models
#
# This file contains the combined code of all project files, as required by
# the assignment submission instructions.
#   Part 1: MSDS25066_05_train.py  (Data loader, forward diffusion, U-Net
#           model, custom loss, training loop, sampling/generation function)
#   Part 2: MSDS25066_05_test.py   (Loads a saved trained model and generates
#           a sample image from pure noise)
# ==============================================================================


# ==============================================================================
# PART 1: MSDS25066_05_train.py
# ==============================================================================
...
# ==============================================================================
# PART 2: MSDS25066_05_test.py
# ==============================================================================
# NOTE: In the actual project, this file imports from MSDS25066_05_train.py
# (e.g. "from MSDS25066_05_train import UNet, generate_image, ..."). Since
# all of that code is already defined above in Part 1 of this combined file,
# those names are already available — the import line below is kept for
# reference/clarity of which file this section came from, and is safe even
# if run on its own since Part 1 precedes it in this file.
